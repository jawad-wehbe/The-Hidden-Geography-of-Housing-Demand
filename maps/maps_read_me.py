...
#   (~/Desktop/Raw_Data/Shapefiles/LA).
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/output/figures/hidden_geography_of_housing_demand/nonbots/maps/{la_code}_{la_name}_la_gap_per_km2.png
...
#   (~/Desktop/Raw_Data/Shapefiles/Other/scotland_settlements_centroids).
# --------------------------------------------------------------------------------
# Script Purpose and Workflow
# --------------------------------------------------------------------------------
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/output/figures/hidden_geography_of_housing_demand/nonbots/maps/gap_rank_map.png
...
# Outputs
# --------------------------------------------------------------------------------
# All written to housing_targets/output/figures/hidden_geography_of_housing_demand/nonbots/maps/
