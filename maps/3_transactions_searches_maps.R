...
# DEMO 2026-09-15 (Jawad): only the week -1 levels map (figure 3) and the week +4 vs -1 log % change map (figure 5L) are kept; the other figures below are commented out
...
# print(fig3)   # DEMO 2026-09-15 (Jawad): print commented out; under Rscript it wrote the figure to a stray Rplots.pdf. The figure is saved right below.
...
# DEMO 2026-09-15 (Jawad): only figure 5L (week +4 vs -1 log % change) is kept; the other log % change figures are commented out
...
# print(fig5_log)   # DEMO 2026-09-15 (Jawad): print commented out; under Rscript it wrote the figure to a stray Rplots.pdf. The figure is saved right below.
