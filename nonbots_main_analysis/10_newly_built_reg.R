...
fig_dir <- file.path(project_root, "output/figures/hidden_geography_of_housing_demand/nonbots/")   # CONFIG
...
weekly_reg_dataset_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/regression_datasets/greenspace_newbuilds_weekly_reg_dataset_complete.parquet")   # CONFIG

monthly_reg_dataset_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/regression_datasets/greenspace_newbuilds_monthly_reg_dataset_complete.parquet")   # CONFIG
...
# DEMO: weekly new-builds block commented out on 2026-09-11 (Jawad: new builds are monthly only). Monthly block below is unchanged.
# ##########################################################################
...
# ##########################################################################
# 
# assign transactions to OAs   (# DEMO: kept live because the monthly block below still uses transactions_oa)
