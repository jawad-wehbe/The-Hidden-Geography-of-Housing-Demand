...
##############################################################
# The full event-study pipeline linking property searches to construction supply shocks,
...
# Datasets Used
# --------------------------------------------------------------------------------
# - The non-bot filtered search database (search_filtered_db in config), providing search_buying and
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/temp/hidden_geography_of_housing_demand/search_buying_searches_by_week.parquet
# - housing_targets/temp/hidden_geography_of_housing_demand/search_letting_searches_by_week.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/all/oa_weekly_search.parquet
...
#   of that search area falling in each OA (search_raw_dir in config).
# - The two weekly search Parquet files written by 1_search_by_location.py.
# --------------------------------------------------------------------------------
# Script Purpose and Workflow
# --------------------------------------------------------------------------------
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/temp/hidden_geography_of_housing_demand/oa_weekly_search_w{week}_{year}.csv
...
#   crosswalks (~/Desktop/Raw_Data/Shapefiles/Crosswalks).
# --------------------------------------------------------------------------------
# Script Purpose and Workflow
# --------------------------------------------------------------------------------
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/all/oa_weekly_search_with_geos.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/all/ed_control_oa_weekly.parquet
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/all/sd_control_oa_weekly.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/all/ed_reg_dataset.parquet
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/all/sd_reg_dataset.parquet
...
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/all/supply_shock_all_eventstudy_results_tidy.csv
# - housing_targets/output/figures/hidden_geography_of_housing_demand/nonbots/nonbots_all_sd_filtered_pooled_buying.png
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/temp/hidden_geography_of_housing_demand/duckcb_greenspace.duckdb, table oa_greenspace_summary, holding
#   median_avg_greenspace_m2 and the number of land fragments per OA.
# - housing_targets/temp/hidden_geography_of_housing_demand/land_sample.gpkg, land_use.gpkg, buildings.gpkg, building_lookup.csv
...
# - housing_targets/output/figures/hidden_geography_of_housing_demand/nonbots/greenspace_oa_percentiles.png
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/output/figures/hidden_geography_of_housing_demand/nonbots/
...
#   England and for Wales (~/Desktop/Raw_Data/Shapefiles/Other/Floods).
...
# - housing_targets/output/figures/hidden_geography_of_housing_demand/nonbots/ the matching PNGs
