...
shock_path      <- file.path(project_root, "produced/search_on_build_shock/setup/ed_shock_oa.parquet")   # CONFIG
cw_oa_msoa_path <- file.path(shapefiles_root, "Crosswalks/oa_msoa.parquet")   # CONFIG
control_path    <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/all/ed_control_oa_weekly.parquet")   # CONFIG
