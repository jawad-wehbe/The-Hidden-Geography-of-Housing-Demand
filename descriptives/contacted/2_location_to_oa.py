...
script_dir = Path("~/Desktop/Projects/housing_targets/code/fergie_backup/code_housing_target/nature/nonbots/contacted/").expanduser()
sb_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_buying_searches_by_week_contacted.parquet").expanduser()
sl_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_letting_searches_by_week_contacted.parquet").expanduser()
...
output_path = Path("~/Desktop/Projects/housing_targets/produced/nature/nonbots/contacted/oa_weekly_search.parquet").expanduser()
#output_path.parent.mkdir(parents=True, exist_ok=True)

# Collect all weekly CSV file paths
csv_files = sorted(input_dir.glob("oa_weekly_search_contacted_w*.csv"))
