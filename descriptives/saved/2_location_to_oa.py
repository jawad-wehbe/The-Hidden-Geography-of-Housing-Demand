...
script_dir = Path("~/Desktop/Projects/housing_targets/code/fergie_backup/code_housing_target/nature/nonbots/saved/").expanduser()
sb_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_buying_searches_by_week_saved.parquet").expanduser()
sl_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_letting_searches_by_week_saved.parquet").expanduser()
...
output_path = Path("~/Desktop/Projects/housing_targets/produced/nature/nonbots/saved/oa_weekly_search.parquet").expanduser()
