...
buying_path = sb_dir = PROJECT_ROOT / "temp/hidden_geography_of_housing_demand/search_buying_searches_by_week_saved.parquet"   # CONFIG
letting_path = PROJECT_ROOT / "temp/hidden_geography_of_housing_demand/search_letting_searches_by_week_saved.parquet"   # CONFIG
