...
buying_path = sb_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_buying_searches_by_week_saved.parquet").expanduser()
letting_path = Path("~/Desktop/Projects/housing_targets/temp/nature/search_letting_searches_by_week_saved.parquet").expanduser()
output_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/").expanduser()
out_path = output_dir / f"oa_weekly_search_saved_w{week:02}_{year}.csv"
