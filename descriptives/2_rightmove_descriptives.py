...
spill_dir = Path("~/Desktop/Projects/housing_search/temp/duckdb_spill/").expanduser()
...
output_dir = Path("~/Desktop/Projects/housing_targets/output/tables/nature_cities/").expanduser()

# search location lookup path

location_lookup_path = Path("~/Desktop/Raw_Data/Rightmove/search_location_lookup.csv").expanduser()
