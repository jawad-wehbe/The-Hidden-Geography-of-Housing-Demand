...
# Filters
SAVED_FILTER = "(total_search_number_properties_saved > 0 OR total_details_page_save_property > 0)"
...
def process_searches(table_name: str):
    query = f"""
        ...
        WHERE 
            ...
            AND user_id_num IN (
                ...
                FROM {table_name}
                WHERE {SAVED_FILTER} AND {CONTACTED_FILTER}
            )
    ...
    output_path = output_dir / f"{table_name}_searches_by_week_both.parquet"
