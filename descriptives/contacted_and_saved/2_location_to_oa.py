...
sb_dir = PROJECT_ROOT / "temp/hidden_geography_of_housing_demand/search_buying_searches_by_week_both.parquet"   # CONFIG
sl_dir = PROJECT_ROOT / "temp/hidden_geography_of_housing_demand/search_letting_searches_by_week_both.parquet"   # CONFIG
...
output_path = PROJECT_ROOT / "produced/hidden_geography_of_housing_demand/nonbots/contacted_and_saved/oa_weekly_search.parquet"   # CONFIG
