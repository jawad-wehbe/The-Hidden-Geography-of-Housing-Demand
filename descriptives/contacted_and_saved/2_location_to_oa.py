...
script_dir = Path("~/Desktop/Projects/housing_targets/code/fergie_backup/code_housing_target/nature/nonbots/contacted_and_saved/").expanduser()
sb_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_buying_searches_by_week_both.parquet").expanduser()
sl_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_letting_searches_by_week_both.parquet").expanduser()
...
output_path = Path("~/Desktop/Projects/housing_targets/produced/nature/nonbots/contacted_and_saved/oa_weekly_search.parquet").expanduser()

# Collect all weekly CSV file paths
csv_files = sorted(input_dir.glob("oa_weekly_search_both_w*.csv"))
