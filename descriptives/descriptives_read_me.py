##############################################################
# 1_search_descriptives.py
##############################################################
# --------------------------------------------------------------------------------
# Datasets Used
# --------------------------------------------------------------------------------
# - The non-bot filtered search database (search_filtered_db in config), providing search_buying,
#   search_letting, session_buying, and session_letting (~/Desktop/Projects/housing_search/produced/nonbots).
# - The original search database (search_processed_db in config), used only for the listings table.
# - search_location_lookup.csv. The lookup used to keep only outcode, region, and station locations.
# --------------------------------------------------------------------------------
# Script Purpose and Workflow
# --------------------------------------------------------------------------------
# Build one summary-statistics table of search activity over the year from 31 May 2023 to
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/output/tables/hidden_geography_of_housing_demand/summary_table.tex
...
# Datasets Used
# --------------------------------------------------------------------------------
# - oa_la_combined_stats_2024.csv. The combined demand gap per OA (housing_targets/produced/gap).
# - oa_map_variables.csv. Average 2024 rental and sales asking prices per OA
#   (housing_targets/produced/gap).
# --------------------------------------------------------------------------------
# Script Purpose and Workflow
# --------------------------------------------------------------------------------
# Show how 2024 asking prices relate to the demand gap per km2 across output areas.
# 1. Read the combined gap and the OA prices and merge them by OA.
# 2. Scatter the average rental price and the average sales price against the gap per km2.
# 3. (Commented out) cut the gap into 50 quantile bins and plot the mean sales price per bin.
# --------------------------------------------------------------------------------
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/output/figures/hidden_geography_of_housing_demand/descriptives/rental_price_vs_gap.png
# - housing_targets/output/figures/hidden_geography_of_housing_demand/descriptives/sales_price_vs_gap.png
# - (binned-means plot commented out)
...
#                        Suffix: _saved
#                        Panel:  produced/hidden_geography_of_housing_demand/nonbots/saved/oa_weekly_search.parquet
#
#   contacted            Users who sent at least one email to an agent (total_email_sent > 0)
#                        Suffix: _contacted
#                        Panel:  produced/hidden_geography_of_housing_demand/nonbots/contacted/oa_weekly_search.parquet
#
#   contacted_and_saved  Users who did both
#                        Suffix: _contacted_and_saved
#                        Panel:  produced/hidden_geography_of_housing_demand/nonbots/contacted_and_saved/oa_weekly_search.parquet
#
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/temp/hidden_geography_of_housing_demand/search_buying_searches_by_week{suffix}.parquet
# - housing_targets/temp/hidden_geography_of_housing_demand/search_letting_searches_by_week{suffix}.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/{sample}/oa_weekly_search.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/temp/hidden_geography_of_housing_demand/oa_weekly_search{suffix}_w{week}_{year}.csv