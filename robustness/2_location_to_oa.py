...
sb_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_buying_searches_by_week_saved_or_contacted.parquet").expanduser()
sl_dir = Path("~/Desktop/Projects/housing_targets/temp/nature/search_letting_searches_by_week_saved_or_contacted.parquet").expanduser()
...
output_path = Path("~/Desktop/Projects/housing_targets/produced/nature/nonbots/saved_or_contacted/oa_weekly_search.parquet").expanduser()
