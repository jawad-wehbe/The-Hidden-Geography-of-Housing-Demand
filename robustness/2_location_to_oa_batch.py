...
buying_path = Path("~/Desktop/Projects/housing_targets/temp/nature/search_buying_searches_by_week_saved_or_contacted.parquet").expanduser()
letting_path = Path("~/Desktop/Projects/housing_targets/temp/nature/search_letting_searches_by_week_saved_or_contacted.parquet").expanduser()
