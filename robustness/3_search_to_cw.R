...
# set up paths 
search_out_dir <- path.expand("~/Desktop/Projects/housing_targets/produced/nature/nonbots/saved_or_contacted/")
...
cw_dir <- path.expand("~/Desktop/Raw_Data/Shapefiles etc/Crosswalks")
