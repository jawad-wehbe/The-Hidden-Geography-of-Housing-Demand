...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/temp/hidden_geography_of_housing_demand/search_buying_searches_by_week_saved_or_contacted.parquet
# - housing_targets/temp/hidden_geography_of_housing_demand/search_letting_searches_by_week_saved_or_contacted.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/oa_weekly_search.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/temp/hidden_geography_of_housing_demand/oa_weekly_search_saved_or_contacted_w{week}_{year}.csv
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/oa_weekly_search_with_geos.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/ed_control_oa_weekly.parquet
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/sd_control_oa_weekly.parquet
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/floods_weekly_reg_dataset.parquet
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/
...
#   (housing_targets/temp/hidden_geography_of_housing_demand).
# - oa_weekly_search_with_geos.parquet. The saved-or-contacted panel from 3_search_to_cw.R.
...
# Outputs
# --------------------------------------------------------------------------------
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/greenspace_weekly_reg_dataset.parquet
# - housing_targets/produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/
