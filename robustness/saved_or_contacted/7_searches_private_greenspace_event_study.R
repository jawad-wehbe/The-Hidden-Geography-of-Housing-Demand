...
weekly_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/oa_weekly_search_with_geos.parquet")   # CONFIG
...
dataset_path <- file.path(project_root, "temp/hidden_geography_of_housing_demand/searches_greenspace.parquet")   # CONFIG

weekly_reg_dataset_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/greenspace_weekly_reg_dataset.parquet")   # CONFIG

results_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/saved_or_contacted_results_greenspace_weekly.csv")   # CONFIG
