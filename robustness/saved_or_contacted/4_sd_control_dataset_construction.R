...
# ────────────────────────────────────────────────────────────────────────────
# VIP: USES SHOCK AS PLOT START DATE
# ────────────────────────────────────────────────────────────────────────────
...
shock_path       <- file.path(project_root, "produced/search_on_build_shock/setup/sd_shock_oa.parquet")   # CONFIG
cw_msoa_path     <- file.path(shapefiles_root, "Crosswalks/oa_msoa.parquet")   # CONFIG
control_out_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/sd_control_oa_weekly.parquet")   # CONFIG
# ────────────────────────────────────────────────────────────────────────────
