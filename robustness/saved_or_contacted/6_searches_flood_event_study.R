...
weekly_reg_dataset_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/floods_weekly_reg_dataset.parquet")   # CONFIG

results_path <- file.path(project_root, "produced/hidden_geography_of_housing_demand/nonbots/saved_or_contacted/saved_or_contacted_results_floods_event_weekly.csv")   # CONFIG
