...
spill_dir    = PROJECT_ROOT / "temp/duckdb_spill"   # CONFIG
buying_path = PROJECT_ROOT / "temp/hidden_geography_of_housing_demand/search_buying_searches_by_week_saved_or_contacted.parquet"   # CONFIG
letting_path = PROJECT_ROOT / "temp/hidden_geography_of_housing_demand/search_letting_searches_by_week_saved_or_contacted.parquet"   # CONFIG
output_dir = PROJECT_ROOT / "temp/hidden_geography_of_housing_demand"   # CONFIG
out_path = output_dir / f"oa_weekly_search_saved_or_contacted_w{week:02}_{year}.csv"
